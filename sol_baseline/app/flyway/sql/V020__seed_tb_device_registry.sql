-- V020__seed_tb_device_registry.sql
------------------------------------------------------------
-- Seed sample data into app.device_registry for development and testing.
------------------------------------------------------------

SET LOCAL ROLE app_owner;

INSERT INTO app.device_registry (alias, device_uuid, api_key_hash)
VALUES
